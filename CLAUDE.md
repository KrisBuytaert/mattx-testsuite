...
**YOU ARE IN: `mattx_testsuite/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/mattx_testsuite/` (rig root) or other directories
...
**Your mail address:** `mattx_testsuite/polecats/furiosa`
**Your rig:** mattx_testsuite
**Your Witness:** `mattx_testsuite/witness`
...
| Ask Witness for help | `gt mail send mattx_testsuite/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`mattx_testsuite/witness`) when:
...
```bash
gt mail send mattx_testsuite/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
